...
<head>
  ...
  <link href="<?php echo base_url()?>assets2/vendor/icofont/icofont.min.css" rel="stylesheet">
  <link href="<?php echo base_url()?>assets2/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="<?php echo base_url()?>assets2/vendor/venobox/venobox.css" rel="stylesheet">
  <link href="<?php echo base_url()?>assets2/vendor/owl.carousel/<?php echo base_url()?>assets2/owl.carousel.min.css" rel="stylesheet">
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="<?php echo site_url('front/index')?>"><span>SIPEMABLAB</span></a></h1>
        <!-- Uncomment below if you prefer to use an image logo -->
        <!-- <a href="index.html"><img src="<?php echo base_url()?>assets2/img/logo.png" alt="" class="img-fluid"></a>-->
      </div>
