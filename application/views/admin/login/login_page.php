...
<body class="bg-gradient-primary fontPoppins">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-xl-10 col-lg-12 col-md-9">
        <center>
          ...
          <span style="color: white"><?php echo $settings_app[0]->setting_origin_app?></span>
        </center>
        <hr>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <?php echo form_close(); ?>
                  <hr>
                  <center style="font-size: 12px;">Copyright @2020, <?php echo $settings_app[0]->setting_origin_app;?><br>Support By <a href="http://hmti-uho.com" class="text-danger" >HMTI UHO</a></center>
                  <!-- <div class="text-center">
