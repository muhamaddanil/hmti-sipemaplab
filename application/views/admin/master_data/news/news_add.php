<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      ...
      <?php echo form_open_multipart("news/input")?>
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        ...
        <textarea class="form-control" name="news_text" id="editor1" rows="10" cols="80" required="required"></textarea>
      </div>
      <div class="form-group">
        <label for=""><b>Tanggal Berita</b></label>
        <input type="date" class="form-control" name="news_date" required="required">
      </div>
      <div class="form-group">
      ...
      <hr>
      <button style="width: 100%" class="btn btn-success" type="submit">Tambah Berita</button>
      <?php echo form_close(); ?>
    </div>
  </div>
